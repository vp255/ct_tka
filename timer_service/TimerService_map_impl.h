...
// ----------------------------- TimerService_map_impl class declaration ----------------------------------
class TimerService_map_impl final {
public:
  // TimerService_map_impl event listener interface.
  class IListener {
  public:
    // Arguments:
  ...
  TimerService_map_impl(epoch_ns_t current_time_ns);

  // Destructor
  ~TimerService_map_impl();
